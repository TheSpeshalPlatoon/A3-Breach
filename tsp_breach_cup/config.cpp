...
class CfgMagazines {
	...
	class CUP_PipeBomb_M: CUP_TimeBomb_M {
		class ACE_Triggers {
			SupportedTriggers[] = {"Timer", "Command", "MK16_Transmitter", "DeadmanSwitch", "Cellphone", "Shock30", "Shock15", "Shock5"};
			class Shock {FuseTime = 3;}; class ShockShort {FuseTime = 1;};
		};
	};
	class CUP_IED_V1_M: CUP_Mine_M {
		class ACE_Triggers {
			SupportedTriggers[] = {"Timer", "Cellphone", "PressurePlate", "Command", "MK16_Transmitter", "DeadmanSwitch", "Shock30", "Shock15", "Shock5"};
			class Shock {FuseTime = 3;}; class ShockShort {FuseTime = 1;};
		};
	};
