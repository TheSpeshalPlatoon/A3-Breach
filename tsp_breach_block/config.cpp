...
class CfgVehicles {
    ...
    class tsp_breach_block_place: ACE_Explosives_Place_SLAM {ammo = "tsp_breach_block_ammo"; model = "tsp_breach_block\block_ammo.p3d"; class EventHandlers {init = "[_this#0,-1,[1,1,1,1,0],0.5] spawn tsp_fnc_breach_explosive";};};
    class tsp_breach_block_auto_place: tsp_breach_block_place {class EventHandlers {init = "[_this#0,tsp_cba_breach_auto,[1,1,1,1,0],0.5] spawn tsp_fnc_breach_explosive";};};
};
